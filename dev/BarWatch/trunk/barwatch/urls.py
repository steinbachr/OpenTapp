...
from barwatch.barportal import views
...
##HOME PATTERNS###
urlpatterns = patterns('barwatch.barportal.views',
    url(r'^$', 'home'),        
...
urlpatterns += patterns('',
    ...
    url(r'^api/singlecoupons/(?P<coupon>\d+)/redeem/$', 'barwatch.barportal.views.redeem_coupon', {'type': e.DealTypes.SINGLE}),
    url(r'^api/groupcoupons/(?P<coupon>\d+)/invite/$', 'barwatch.barportal.views.invite_group'),
    url(r'^api/groupcoupons/(?P<coupon>\d+)/redeem/$', 'barwatch.barportal.views.redeem_coupon', {'type': e.DealTypes.GROUP}),
...
urlpatterns += patterns('barwatch.barportal.internal_services',
