...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bar'
        db.create_table('opentapp.barportal_bar', (
        ...
        db.send_create_signal('opentapp.barportal', ['Bar'])

        # Adding model 'BarUser'
        db.create_table('opentapp.barportal_baruser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('bar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.Bar'])),
        ))
        db.send_create_signal('opentapp.barportal', ['BarUser'])

        # Adding model 'Menu'
        db.create_table('opentapp.barportal_menu', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bar', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opentapp.barportal.Bar'], unique=True)),
        ))
        db.send_create_signal('opentapp.barportal', ['Menu'])

        # Adding model 'MenuItem'
        db.create_table('opentapp.barportal_menuitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('menu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.Menu'])),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('opentapp.barportal', ['MenuItem'])

        # Adding model 'SingleCoupon'
        db.create_table('opentapp.barportal_singlecoupon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.Bar'])),
            ('applies_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.MenuItem'], null=True, blank=True)),
        ...
        db.send_create_signal('opentapp.barportal', ['SingleCoupon'])

        # Adding model 'GroupCoupon'
        db.create_table('opentapp.barportal_groupcoupon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.Bar'])),
            ('applies_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.MenuItem'], null=True, blank=True)),
            ('coupon_description', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal('opentapp.barportal', ['GroupCoupon'])

        # Adding model 'MobileUser'
        db.create_table('opentapp.barportal_mobileuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fb_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('opentapp.barportal', ['MobileUser'])

        # Adding model 'GroupRedemption'
        db.create_table('opentapp.barportal_groupredemption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.MobileUser'])),
            ('applies_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.GroupCoupon'])),
        ))
        db.send_create_signal('opentapp.barportal', ['GroupRedemption'])

        # Adding model 'GroupMembers'
        db.create_table('opentapp.barportal_groupmembers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.GroupRedemption'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.MobileUser'])),
            ('has_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('opentapp.barportal', ['GroupMembers'])

        # Adding model 'CouponRedemption'
        db.create_table('opentapp.barportal_couponredemption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('touch_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('phone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.MobileUser'], null=True, blank=True)),
            ('single_coupon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.SingleCoupon'], null=True, blank=True)),
            ('group_coupon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.GroupCoupon'], null=True, blank=True)),
        ))
        db.send_create_signal('opentapp.barportal', ['CouponRedemption'])

        # Adding model 'Payment'
        db.create_table('opentapp.barportal_payment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('touch_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('bar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opentapp.barportal.Bar'])),
            ('amount', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('opentapp.barportal', ['Payment'])

        # Adding model 'User'
        db.create_table('opentapp.barportal_user', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('opentapp.barportal', ['User'])


    def backwards(self, orm):
        # Deleting model 'Bar'
        db.delete_table('opentapp.barportal_bar')

        # Deleting model 'BarUser'
        db.delete_table('opentapp.barportal_baruser')

        # Deleting model 'Menu'
        db.delete_table('opentapp.barportal_menu')

        # Deleting model 'MenuItem'
        db.delete_table('opentapp.barportal_menuitem')

        # Deleting model 'SingleCoupon'
        db.delete_table('opentapp.barportal_singlecoupon')

        # Deleting model 'GroupCoupon'
        db.delete_table('opentapp.barportal_groupcoupon')

        # Deleting model 'MobileUser'
        db.delete_table('opentapp.barportal_mobileuser')

        # Deleting model 'GroupRedemption'
        db.delete_table('opentapp.barportal_groupredemption')

        # Deleting model 'GroupMembers'
        db.delete_table('opentapp.barportal_groupmembers')

        # Deleting model 'CouponRedemption'
        db.delete_table('opentapp.barportal_couponredemption')

        # Deleting model 'Payment'
        db.delete_table('opentapp.barportal_payment')

        # Deleting model 'User'
        db.delete_table('opentapp.barportal_user')
    ...
    models = {
        ...
        'opentapp.barportal.baruser': {
            'Meta': {'object_name': 'BarUser'},
            'bar': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.Bar']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'})
        },
        'opentapp.barportal.couponredemption': {
            'Meta': {'object_name': 'CouponRedemption'},
            'group_coupon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.GroupCoupon']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.MobileUser']", 'null': 'True', 'blank': 'True'}),
            'single_coupon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.SingleCoupon']", 'null': 'True', 'blank': 'True'}),
            'touch_datetime': ('django.db.models.fields.DateTimeField', [], {})
        },
        'opentapp.barportal.groupcoupon': {
            'Meta': {'object_name': 'GroupCoupon'},
            'applies_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.MenuItem']", 'null': 'True', 'blank': 'True'}),
            'bar': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.Bar']"}),
        ...
        'opentapp.barportal.groupmembers': {
            'Meta': {'object_name': 'GroupMembers'},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.GroupRedemption']"}),
            'has_confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.MobileUser']"})
        },
        'opentapp.barportal.groupredemption': {
            'Meta': {'object_name': 'GroupRedemption'},
            'applies_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.GroupCoupon']"}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.MobileUser']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'opentapp.barportal.menu': {
            'Meta': {'object_name': 'Menu'},
            'bar': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['opentapp.barportal.Bar']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'opentapp.barportal.menuitem': {
            'Meta': {'object_name': 'MenuItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opentapp.barportal.Menu']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'})
        },
        'opentapp.barportal.mobileuser': {
            'Meta': {'object_name': 'MobileUser'},
            'fb_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'opentapp.barportal.payment': {
        ...
        'opentapp.barportal.singlecoupon': {
    ...
    complete_apps = ['opentapp.barportal']