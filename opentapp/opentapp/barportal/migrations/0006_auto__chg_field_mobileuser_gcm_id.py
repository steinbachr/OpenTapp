...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('opentapp.barportal_mobileuser', 'gcm_id', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'MobileUser.gcm_id'
        db.alter_column('opentapp.barportal_mobileuser', 'gcm_id', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'opentapp.barportal.groupmembers': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group_members'", 'to': "orm['opentapp.barportal.GroupRedemption']"}),
        ...
        'opentapp.barportal.mobileuser': {
            ...
            'gcm_id': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
