...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MobileUser.gcm_id'
        db.add_column('opentapp.barportal_mobileuser', 'gcm_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MobileUser.gcm_id'
        db.delete_column('opentapp.barportal_mobileuser', 'gcm_id')
    ...
    models = {
        ...
        'opentapp.barportal.mobileuser': {
            ...
            'gcm_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
