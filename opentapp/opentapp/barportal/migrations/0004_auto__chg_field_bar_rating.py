...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bar.rating'
        db.alter_column('opentapp.barportal_bar', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Bar.rating'
        db.alter_column('opentapp.barportal_bar', 'rating', self.gf('django.db.models.fields.IntegerField')(default=None))
